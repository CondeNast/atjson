...
document.querySelector('button').addEventListener('click', () => {
  document.body.innerText = JSON.stringify(URLSource.fromRaw('https://twitter.com/jennschiffer/status/708888255828250625').convertTo(OffsetSource).toJSON(), null, 2);
});
