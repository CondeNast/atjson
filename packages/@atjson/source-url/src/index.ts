    ...
    try {
      ...
      return new this({
        ...
        annotations: [{
          ...
          attributes: {
            '-whatwg-host': url.host,
            '-whatwg-hash': url.hash,
            '-whatwg-pathname': url.pathname,
            '-whatwg-protocol': url.protocol,
            '-whatwg-searchParams': searchParams
          }
        }]
      });
    } catch (e) {
