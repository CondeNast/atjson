...
:::note
atjson is made up of a bunch of packages. Think of these as
...
atjson decouples _content_ from _semantics_. Take the sentence,
    ...
    new QuickBrownFoxSource({
      ...
      annotations: [
        ...
        new Image({
          ...
          attributes: {
            src: "https://media.giphy.com/media/gdUxfKtxSxqtq/200w_d.gif",
          },
        }),
      ],
    })
