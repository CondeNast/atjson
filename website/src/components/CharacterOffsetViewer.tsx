  ...
  return (
    <Container ref={ref}>
      <PositionalInfo>
        ...
        {cursor[0] > -1 &&
          <SelectedOffset
            x={endPoints[cursor[0]].x - offsetDims[cursor[0]].width / 2 - padding / 2}
            y={endPoints[cursor[0]].y + 3}
            width={
              (endPoints[cursor[1]].x + offsetDims[cursor[1]].width / 2) -
              (endPoints[cursor[0]].x - offsetDims[cursor[0]].width / 2) + padding
            }
